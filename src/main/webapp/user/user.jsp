	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				<form method="get" action="${cp }/userModified" class="form-horizontal" role="form">
					...
					<div class="form-group">
						<label for="userNm" class="col-sm-2 control-label">사용자 아이디${user.realfilename2 }</label>
						<div class="col-sm-10">
				...
				<!--<a href="${cp }/userModified" class="btn btn-default">사용자 정보 수정</a>   -->
						</div>
					</div>
