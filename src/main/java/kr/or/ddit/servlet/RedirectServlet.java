...
public class RedirectServlet extends HttpServlet {
	...
	//localhost : 8081 /redirectServlet get => doGet효출
	//웹브라우저 주소줄에 url을 입력하고 엔터를 입력하면 get방식의 요청
	
	//redirectForm.jsp에게 응답 생성을 위임
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		//print writer객체를 이용하여 html 코드를 직접 작성하는 것이 아니라 화면을 생성하는 jsp에게 요청을 위임
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		response.sendRedirect(request.getContextPath() + "/jsp/jsp/login.jsp");
	}
